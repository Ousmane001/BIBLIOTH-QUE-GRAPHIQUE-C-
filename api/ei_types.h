...
/**
 * @brief	A character string, C-like (terminated with the character \0).
 */
typedef char*				ei_string_t;

/**
 * @brief	An immutable character string, C-like (terminated with the character \0).
 */
typedef const char*			ei_const_string_t;

/**
 * @brief	An opaque pointer used by the programmer.
 */
...
/**
 * @brief	A pointer to a 2-D size.
 */
typedef ei_size_t*			ei_size_ptr_t;
...
/**
 * @brief	A pointer to a rectangle.
 */
typedef ei_rect_t*			ei_rect_ptr_t;
...
#define					EI_VERSION_MAJOR	3
#define					EI_VERSION_RELEASE	2
#define					EI_VERSION_SERIAL	0
#define					EI_VERSION		"3.2.0"
static inline ei_string_t		ei_version_string() { return EI_VERSION; }
static inline void			ei_version(int* major, int* release, int* serial) { *major = EI_VERSION_MAJOR; *release = EI_VERSION_RELEASE, *serial = EI_VERSION_SERIAL; }
